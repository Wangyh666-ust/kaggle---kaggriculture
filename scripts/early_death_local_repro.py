...
the day-0 residue: whether the opponent's step-1 market list co-sells 10 WHEAT
in the same lockstep slot as ours.
...
def cosell_agent(observation, configuration=None):
    """Mirror-opening opponent: buy 10 WHEAT then sell 10 WHEAT in slot 1 at step 1."""
